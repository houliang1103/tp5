...
<div class="box">
    <div class="box-header">
        <ob_link><span class="btn btn-success" >添加菜单</span></ob_link>
        <br/>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label>同级排序</label>
                                <span></span>
                                <input class="form-control" name="sort" placeholder="" type="text">
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label>所属模块</label>
                                <span></span>
                                <input class="form-control" name="module" placeholder="" type="text">
                            </div>
                        </div>
